...
@implementation JLYMaterialTextView
...
- (void)computeLineColor{
    ...
    if (self.valid) {
        ...
        lineColor = [UIColor colorWithRed:255.0f/255.0f green:58.0f/255.0f blue:9.0f/255.0f alpha:1.0f].CGColor;
    }
