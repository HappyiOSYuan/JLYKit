...
typedef NS_ENUM(NSInteger, JLYAlertControllerStyle) {
    JLYAlertControllerStyleActionSheet = 0,
    JLYAlertControllerStyleAlert
};


@interface JLYAlertController : NSObject
...
@property (nonatomic, readonly) JLYAlertControllerStyle style;
...
/** @return An array of \c JLYAlertActions representing all "other button" actions and the cancel button action, if you added one. Gauranteed to never be \c nil. */
- (NSArray *)actions;
...
/** A convenience method for `initWithTitle:message:style:` where \c style is \c JLYAlertControllerStyleAlert.
 @return A \c JLYAlertController with no actions. */
+ (instancetype)alertViewWithTitle:(nullable NSString *)title message:(nullable NSString *)message;
/** A convenience method for `initWithTitle:message:style:` where \c style is \c JLYAlertControllerStyleActionSheet.
 @return A \c JLYAlertController with no actions. */
...
/** A convenience method for creating an alert view style alert controller with a single "OK" button.
 @return A \c JLYAlertController with an "OK" button to dismiss it. */
+ (instancetype)simpleOKAlertWithTitle:(nullable NSString *)title message:(nullable NSString *)message;

/** Initializer that creates a \c JLYAlertController in the specified style with no actions, title, or message. */
- (id)initWithStyle:(JLYAlertControllerStyle)style;
/** Initializer that creates a \c JLYAlertController in the specified style with the given title and message. */
- (id)initWithTitle:(nullable NSString *)title message:(nullable NSString *)message style:(JLYAlertControllerStyle)style;
...
/** Adds a cancel button via a \c JLYAlertAction. */
...
/** Adds a cancel button with a block to be executed when triggered.
 ...
 @param buttonBlock The \c JLYAlertActionBlock to be executed when the button is triggered. */
...
/** Adds a button via a \c JLYAlertAction. */
...
/** Adds a button with a block to be executed when triggered.
 ...
 @param title The button title.
 @param buttonBlock The \c JLYAlertActionBlock to be executed when the button is triggered. */
- (void)addOtherButtonWithTitle:(NSString *)title buttonAction:(JLYAlertActionBlock)buttonBlock;
...
/** Presents the alert controller from the given view controller.
 ...
 @note \c viewController has no effect on iOS 7 when using \c JLYAlertControllerStyleAlert. Using \c JLYAlertControllerStyleActionSheet, the action sheet is shown from `viewController.view.window`.
 
 @param viewController The view controller that should present the alert controller. */
- (void)showFromViewController:(UIViewController *)viewController;
/** Presents the alert controller from the given view controller.
 
 @note \c viewController has no effect on iOS 7 when using \c JLYAlertControllerStyleAlert.
 @note When using \c JLYAlertControllerStyleActionSheet, the action sheet is shown from `viewController.view.window`.
...
- (void)showFromViewController:(UIViewController *)viewController animated:(BOOL)animated completion:(nullable JLYVoidBlock)completion;
...
/** @see Equivalent to calling `dismissAnimated:completion` on \c UIAlertController.
 ...
 @warning This is a feature of \c UIAlertController and only available on iOS 8. */
- (void)dismissAnimated:(BOOL)animated completion:(nullable JLYVoidBlock)completion NS_AVAILABLE_IOS(8_0);
