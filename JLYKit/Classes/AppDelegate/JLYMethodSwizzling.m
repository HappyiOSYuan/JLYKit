...
@implementation JLYMethodSwizzling
...
void SwizzlingMethod(Class class, SEL originSEL, SEL swizzledSEL){
    ...
    if(class_addMethod(class, originSEL, method_getImplementation(swizzledMethod), method_getTypeEncoding(swizzledMethod))){ //自身已经有了就添加不成功，直接交换即可
